...
const initBlob = () => {
  ...
  container.style.zIndex = '-1'; // Put it in background
  ...
  const uniforms = {
    ...
    u_color: { value: new THREE.Color('#ff0055') } // from Home component
  };
  ...
  const tick = () => {
    ...
    // Update uniforms
    material.uniforms.u_time.value = 0.4 * elapsedTime;
    material.uniforms.u_intensity.value = lerp(
    ...
    // Position updates
    targetPosition.set(mouse.x * 0.3, mouse.y * 0.3, 0);
